...
SECRET_KEY = '!x1s$o2*7mquyu@jy0buk$7i#+_dtz1p1xy!b+t7ff#5g-ie90'
...
INSTALLED_APPS = [
    ...
    'django.contrib.auth',  # система аунтентификации
    'django.contrib.contenttypes',  # система для типов контента
